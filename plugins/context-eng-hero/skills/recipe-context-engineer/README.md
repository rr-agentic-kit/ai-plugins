...
- **Lexicon:** Plugin-root `ACRONYMS.md` + `GLOSSARY.md` (always required; harvest overloaded plugin-wide senses on create/design/redesign/extract per `refs/lexicon-spec.md` — not flags/templates)
