...
**Task + Caller Load:** For independent diagnosis, spawn parallel Tasks in one turn and merge in the parent. Implementation SoT: `design/inline-executor.md`. Exemplar: `actions/improve.md` (`compliance` + `opportunity`). Layout picker: `design/design-core.md` **Shared knowledge layout**.
