...
Load severity categories from [shared-heuristics.md](../../skills/s-tester/refs/shared-heuristics.md).
...
`PhaseOutput` with `data` per [contracts.md](../../skills/s-tester/refs/contracts.md) § flaky.
