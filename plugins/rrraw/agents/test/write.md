...
- Load [coverage-exclusions.md](../../skills/s-tester/refs/coverage-exclusions.md) for exclude track execution
...
4. **Minimal-assertion tactics** per [shared-heuristics.md](../../skills/s-tester/refs/shared-heuristics.md):
...
7. Respect verify gate: [determinism.md](../../skills/s-tester/refs/determinism.md).
...
`PhaseOutput` with `data` per [contracts.md](../../skills/s-tester/refs/contracts.md) § write.
