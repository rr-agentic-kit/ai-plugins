...
- Load [coverage-exclusions.md](../../skills/s-tester/refs/coverage-exclusions.md) for `exclude[].tooling`
...
4. Apply **Google S/M/L** sizing from [shared-heuristics.md](../../skills/s-tester/refs/shared-heuristics.md):
...
6. Apply merge/sort rules from [determinism.md](../../skills/s-tester/refs/determinism.md).
...
`PhaseOutput` with `data` per [contracts.md](../../skills/s-tester/refs/contracts.md) § plan.
