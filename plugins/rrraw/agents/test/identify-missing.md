...
Load [shared-heuristics.md](../../skills/s-tester/refs/shared-heuristics.md) for risk heuristic and exhaustive enumeration rules.
Load [coverage-exclusions.md](../../skills/s-tester/refs/coverage-exclusions.md) for excluded routing.
...
`PhaseOutput` with `data` per [contracts.md](../../skills/s-tester/refs/contracts.md) § identify-missing.
