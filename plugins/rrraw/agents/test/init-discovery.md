...
1. Run discovery depth checklist from [init-mode.md](../../skills/s-tester/refs/init-mode.md).
...
4. Discover existing coverage exclusion config and non-testable patterns per [coverage-exclusions.md](../../skills/s-tester/refs/coverage-exclusions.md).
5. Build `claude_md_patch` per [claude-md-schema.md](../../skills/s-tester/refs/claude-md-schema.md) including Coverage exclusions field.

## Output

Return `PhaseOutput` JSON only. `data` contract: [contracts.md](../../skills/s-tester/refs/contracts.md) § init-discovery.
