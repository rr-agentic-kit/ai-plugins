...
**Audience:** Code lane assess; **s-review** Challenge; inline POST Step 2c via **s-ci**.
...
Missing secret exclusions in `.gitignore` (`.env`, keys): coding lane **do not flag**; **s-security** may flag per `secure.principles.md`.
