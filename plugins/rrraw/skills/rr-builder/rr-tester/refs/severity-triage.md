...
**Read:** this ref + cited heuristic rows. Persist sidecar **`REVIEW_DIR/test-assess-challenge.md`** (or `test-assess-<chunk>-challenge.md`). Paths: `rr-review/refs/artifacts.md`.
