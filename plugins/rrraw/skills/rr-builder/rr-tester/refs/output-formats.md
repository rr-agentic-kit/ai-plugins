...
On multi-epoch chains (`complete-missing`, `migrate` with epochs > 1): skill may write/overwrite `.rr-builder/test-report.md` with the same markdown emitted to chat.
