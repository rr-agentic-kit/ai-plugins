...
| Need | Use instead |
|------|-------------|
| One-off test assess/write | **rr-tester** `--tester` |
| MR test-review fix | **rr-review** `--test --fix` |
...
| `skills/rr-builder/rr-review/refs/chunking.md` | Chunk list |
| `skills/rr-builder/rr-tester/refs/shared-heuristics.md` | Cross-lane calibration (assess) |
| `skills/rr-builder/rr-tester/refs/coverage-exclusions.md` | Non-testable taxonomy (assess) |
