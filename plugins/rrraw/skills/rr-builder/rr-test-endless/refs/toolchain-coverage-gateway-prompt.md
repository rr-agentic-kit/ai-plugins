...
**Load path:** `PLUGIN_ROOT/skills/rr-builder/rr-test-endless/refs/toolchain-coverage-gateway-prompt.md`
...
Phases: build, test:coverage only (no lint in this gate). Resolve commands per `skills/rr-builder/rr-test-endless/refs/project-detection.md`. Caller label test:coverage maps to the stack's coverage script when present.
