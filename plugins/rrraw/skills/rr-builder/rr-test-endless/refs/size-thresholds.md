...
**Dispatch geometry:** **`skills/rr-builder/rr-test-endless/refs/work-pack-sizing.md`** is **canonical** for planner packing and orchestrator **`Task`** dispatch (one worker per plan file). This file does **not** define executor batch sizes or step batching.
