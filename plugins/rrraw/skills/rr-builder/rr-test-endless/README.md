...
**Out of scope:** application production-code review; MR merge-oriented test fix (use **rr-review**).

Chunk geometry: **`skills/rr-builder/rr-review/refs/chunking.md`** only.
...
- MR / branch test-review fix → **rr-review** `--test --fix`
- One-off assess / write / migrate → **rr-tester** via **`--tester`**
