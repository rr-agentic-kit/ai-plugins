...
**Read:** this ref + OWASP/confidence criteria. Persist sidecar **`REVIEW_DIR/security-audit-challenge.md`** (or `security-audit-<chunk>-challenge.md`). Paths: `rr-review/refs/artifacts.md`.
