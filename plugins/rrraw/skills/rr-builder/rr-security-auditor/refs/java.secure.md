...
Java-specific secure implementation patterns. CWE Rule IDs and patterns live in `secure.owasp.md`.
...
### SQL injection via @Query string concat (**CWE-89**)
```java
...
### Missing @PreAuthorize on admin endpoints (**CWE-862**)
```java
...
- `secure.owasp.md` — language-agnostic CWE patterns
- `secure.principles.md` — security rules and PII protection
- `rr-coder/refs/java.spring.md` § Security — Spring Security config patterns
