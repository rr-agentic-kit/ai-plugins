...
TypeScript-specific secure patterns. React patterns in `react.secure.md`. CWE Rule IDs in `secure.owasp.md`.
...
### `any` hiding injection vectors (**CWE-89** / **CWE-78**)
```typescript
// BUG
...
### Non-exhaustive switch on permission enum (missing case = unauthorized access — **CWE-863**)
```typescript
// BUG
...
- `secure.owasp.md` — CWE Rule IDs and detection patterns
