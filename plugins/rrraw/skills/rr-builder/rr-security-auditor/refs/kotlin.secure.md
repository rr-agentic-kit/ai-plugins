...
Kotlin-specific secure implementation patterns. CWE Rule IDs and patterns live in `secure.owasp.md`.
...
### String interpolation in @Query — SQL injection (**CWE-89**)
```kotlin
...
- `rr-coder/refs/java.spring.md` § Security — Spring Security config (shared with Java)
