...
**Step line progress** (`- [executed]` / `- [verified]`) in **`## Steps`** is the **authoritative** progress signal — see **`skills/s-test-endless/refs/orchestration.md`** §5.
...
- **`skills/s-test-endless/refs/orchestration.md`** / **`orchestration.md`** §4 — queue from planner artifacts; **`--max-parallel`**.
