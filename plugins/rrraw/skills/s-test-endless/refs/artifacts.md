...
**Purpose:** Path layout and checkpoint schema for **`s-test-endless`**. **`REVIEW_DIR/plans/trp-*.md`** is the sole source of truth for work order and execution progress.

## Run id

Mint per **`skills/s-review/refs/artifacts.md`**: `yyyymmdd-NN` local calendar date + daily counter.
