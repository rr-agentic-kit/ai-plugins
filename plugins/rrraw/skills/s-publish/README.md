...
Publish nested skill. Loaded by **s-ci** for artifact upload — not cluster deploy. Not plugin-listed. Runtime: [SKILL.md](SKILL.md).
...
- Opening the PR/MR that contains the job → parent s-ci + forge skill only
