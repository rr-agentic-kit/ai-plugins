...
**Script:** `skills/rr-git/scripts/clean-merged-local-branches.sh` — invoke from [scripts/README.md](../scripts/README.md). Requires a clean worktree for `--plan`/`--delete` unless the user picks a dirty-tree option below.
