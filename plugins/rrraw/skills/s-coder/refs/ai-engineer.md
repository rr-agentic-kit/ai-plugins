...
- Cross-language Prefer/Avoid, disposition, **CP027**–**CP029**: [`observability.md`](observability.md) — LLM call metrics stay mandatory here; refactor still does not silent-add meters elsewhere
