...
- Cross-language Prefer/Avoid, disposition, **CP027**–**CP029**: [`observability.md`](observability.md) — refactor may hygiene existing logs only; never silent-add `@Observed`/meters
