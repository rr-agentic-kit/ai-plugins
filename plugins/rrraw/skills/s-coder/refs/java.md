...
- Prefer least-necessary visibility (`private` → package-private → `protected` → `public`) per [§ Visibility / encapsulation](code.principles.md#visibility--encapsulation) (**CP030**)
