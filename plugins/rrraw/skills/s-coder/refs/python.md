...
- Use `pathlib.Path` — reject parent-directory path traversal explicitly
...
- `code.principles.md` — cross-language principles (**CP031**: bind repeated helper calls once per scope)
