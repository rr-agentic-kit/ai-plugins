# SRP / cohesion checklist (CP022 / CP015)
...
- Red size / fan-out → **CP022** via **Phase 3** (`god_class`)
- Gray duplication or cohesion red → **CP022** via **Phase 4** (`mixed_responsibility`)
- Fat service method (validate + domain + persist + events) → **CP015**; small-type forks → **CP022**
