...
**Purpose:** Canonical paths for **s-refactor** fixed-point runs. **Convention:** paths are at the **repository root** of the project under refactor, not inside the plugin.
