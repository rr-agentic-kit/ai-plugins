---
name: s-tester
description: /s-tester — flag-driven test excellence via agents/test/*; also via rr-builder --tester or review test lane.
...
- Test assess, gap identification, write/fix/migrate, flaky triage via **rr-builder** `--tester` (full-skill handoff) or **s-review** test lane
...
| Need | Use instead |
|------|-------------|
| Production code standards | **s-coder** |
