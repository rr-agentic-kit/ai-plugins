...
**Out of scope:** CPNNN / SRP / observability (**s-coder**); test verdicts (**s-tester**); auto-fix (unsupported).
...
- Security lane under **s-review** / builder auto **review**
...
- Under **s-review**, severity-triage + confidence gates both apply
