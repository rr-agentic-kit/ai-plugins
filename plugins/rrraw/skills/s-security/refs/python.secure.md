...
Python-specific secure implementation patterns. CWE Rule IDs and patterns in `secure.owasp.md`.
...
### Missing timeout on HTTP requests (SSRF amplification — **CWE-918**)
```python
# BUG
