...
- Skill tree only: `skills/s-humanize/`. No edits to `docs/`, `refs/commands.md`, `COMPONENT-SPECS.md`, `USAGE.md`, plugin README, or `plugin.json`.
...
```bash
python3 skills/s-humanize/scripts/cli.py scan [path]
python3 skills/s-humanize/scripts/cli.py apply-safe [--dry-run] [path]
python3 skills/s-humanize/scripts/cli.py suggest-register [path]
```
