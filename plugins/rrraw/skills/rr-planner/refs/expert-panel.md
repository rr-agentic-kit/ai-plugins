...
The verdict is a **state**, not an exit. Invalidation never auto-flips item status ([decision-ledger.md](decision-ledger.md)).
...
|-------|------------|---------|
| exec-summary | Founder/CEO + seed investor + domain practitioner | Binding |
...
3. Run the re-decision sweep ([decision-ledger.md](decision-ledger.md)).
...
Open `re_decision_queue` or unresolved binding `hold`/`kill` → do not freeze ([success-criteria.md](success-criteria.md), [proactivity.md](proactivity.md)).
