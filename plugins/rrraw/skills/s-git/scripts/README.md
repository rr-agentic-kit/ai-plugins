...
python3 skills/s-git/scripts/resolve_repo_root.py
python3 skills/s-git/scripts/resolve_repo_root.py --candidate <path>

# Finish-commit preflight (merge/rebase)
python3 skills/s-git/scripts/finish_commit_preflight.py
python3 skills/s-git/scripts/finish_commit_preflight.py --repo <path>

# Squash onto base
bash skills/s-git/scripts/squash-onto-base.sh --verify-only [<source-branch>]
bash skills/s-git/scripts/squash-onto-base.sh --force-push [<source-branch>]

# Clean merged local branches
bash skills/s-git/scripts/clean-merged-local-branches.sh --worktree-status
bash skills/s-git/scripts/clean-merged-local-branches.sh --plan
bash skills/s-git/scripts/clean-merged-local-branches.sh --delete

# Version-field merge conflicts (latest semver)
python3 skills/s-git/scripts/resolve_version_conflicts.py --plan
python3 skills/s-git/scripts/resolve_version_conflicts.py --apply
```
